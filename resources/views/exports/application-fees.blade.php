...
@endif
    ...
    <div class="header" style="position:fixed;padding-bottom:3px;">
        ...
        <div style="text-align:center; ">
           ...
           Application Form for Admission to 1st Year of Diploma in Modern Office Practice & Management (MOPM) (Academic Session 2025-26)
            </p>
        </div>
    ...
    <div style="page-break-before: always;">
            ...
            {{-- Subject-wise marks --}}
                ...
                <div style="position: fixed; bottom: 15px; left: 20px; right: 20px; font-size:12px; line-height:1.3;">
                    ...
                    @if($type = 'PREVIEW')
                    <h3 style="color:red;"><span>Note:</span> Your Apllication will be considered only after successful payment. </h3>
                    @endif
