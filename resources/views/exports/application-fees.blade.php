...
<body>
    ...
    <div class="header" style="position:fixed;padding-bottom:3px;">
        ...
        <div style="text-align:center; ">
            <p style="font-size:14px; padding-bottom:10px;margin-top:2px;">
                Application Form for Admission to 1st Year of Diploma in Modern Office Practice & Management (MOPM)
    ...
    <div>
        <table border="1" cellpadding="1" cellspacing="1" style="width:100%;padding-top: 130px;">
            <tbody>
                <tr>
    ...
    <div style="page-break-before: always;">
        ...
        <table style="padding-top:130px; width:100%; border-collapse:collapse;">
            <tr>
        ...
        <table style="padding-top:3px; width:100%; border-collapse:collapse;">
            ...
            <tr>
                <td style="text-align: center; font-size:10px"><strong>Education Details of Madhyamik/Equivalent
                        Examination</strong></td>
                <td style="text-align: center; font-size:10px"><strong>10th School Name</strong></td>
                <td style="text-align: center; font-size:10px"><strong>10th School District</strong></td>
                <td style="text-align: center; font-size:10px"><strong>10th Year of Passing</strong></td>
                <td style="text-align: center; font-size:10px"><strong> 10th Board</strong></td>
                <td style="text-align: center; font-size:10px"><strong>Aggregate Marks of 10th Standard</strong></td>
                <td style="text-align: center; font-size:10px"><strong>Marks Obtained in 10th Standard</strong></td>
                <td style="text-align: center; font-size:10px"><strong>Overall % </strong><span
                        style="font-size:10px;">(Rounded off
                        upto 2 decimal places)</span></td>
            </tr>

            <tr>
                <td style="text-align: center; font-size:10px">{{ $education->exam_elgb_code_one }}</td>
                <td style="text-align: center; font-size:10px">{{ $education->exam_10th_school_name }}</td>
                <td style="text-align: center; font-size:10px">{{ $education->district10th->district_name ?? 'N/A' }}
                </td>
                <td style="text-align: center; font-size:10px">{{ $education->exam_10th_pass_yr }}</td>
                <td style="text-align: center; font-size:10px">{{ strtoupper($education->board10th->board_name) }}</td>
                <td style="text-align: center; font-size:10px">{{ $education->exam_10th_tot_marks ?? 'N/A' }}</td>
                <td style="text-align: center; font-size:10px">{{ $education->exam_10th_ob_marks ?? 'N/A' }}</td>
                <td style="text-align: center; font-size:10px">{{ $education->exam_10th_percentage ?? 'N/A' }}

                </td>
            </tr>
            <tr>
                <td style="text-align: center; font-size:10px"><strong>Educational Details of Higher
                        Secondary/Equivalent Examination</strong></td>
                <td style="text-align: center; font-size:10px"><strong>12th School Name</strong></td>
                <td style="text-align: center; font-size:10px"><strong>12th School District</strong></td>
                <td style="text-align: center; font-size:10px"><strong>12th Year of Passing</strong></td>
                <td style="text-align: center; font-size:10px"><strong> 12th Board</strong></td>
                <td style="text-align: center; font-size:10px"><strong>Aggregate Marks of 12th Standard</strong></td>
                <td style="text-align: center; font-size:10px"><strong>Marks Obtained in 12th Standard</strong></td>
                <td style="text-align: center; font-size:10px"><strong>Overall % </strong><span
                        style="font-size:10px;">(Rounded off
                        upto 2 decimal places)</span></td>
            </tr>
            ...
            <tr>
                <td style="text-align: center; font-size:10px">{{ $education->exam_elgb_code_two }}</td>
                <td style="text-align: center; font-size:10px">{{ $education->exam_12th_school_name }}</td>
                <td style="text-align: center; font-size:10px">{{ $education->district12th->district_name ?? 'N/A' }}
                </td>
                <td style="text-align: center; font-size:10px">{{ $education->exam_12th_pass_yr }}</td>
                <td style="text-align: center; font-size:10px">{{ strtoupper($education->board12th->board_name) }}</td>
                <td style="text-align: center; font-size:10px">{{ $education->exam_12th_tot_marks ?? 'N/A' }}</td>
                <td style="text-align: center; font-size:10px">{{ $education->exam_12th_ob_marks ?? 'N/A' }}</td>
                <td style="text-align: center; font-size:10px">{{ $education->exam_12th_percentage ?? 'N/A' }}
                </td>
            </tr>
        ...
        <div style="position: fixed; bottom: 15px; left: 20px; right: 20px; font-size:12px; line-height:1.3;">
            ...
            @if ($type = 'PREVIEW')
                <h3 style="color:red;"><span>Note:</span> Your Apllication will be considered only after successful
                    payment. </h3>
            @endif
