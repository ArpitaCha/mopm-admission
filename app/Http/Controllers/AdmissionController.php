    ...
    */
    ...
    private function rulesStep3($request)
    {
        $rules = [
            ...
            'exam_10th_marks'            => ['required', 'json'],
            'exam_12th_marks'            => ['required', 'json'],
    ...
    private function rulesStep4($request)
    {
        $rules = [
            ...
            'bank_passbook_document' => ['required', 'file', 'mimes:pdf', 'max:2048'], // max 2 MB
        ];
        $validator = Validator::make($request->all(), $rules);
        if ($validator->fails()) {
            return response()->json(['errors' => $validator->errors()], 422);
        ...
        try {
            ...
            ApplElgbExam::updateOrCreate(
                ...
                [
                   ...
                   'exam_10th_per_marks'        => $request->exam_10th_marks,
                    'exam_12th_per_marks'        => $request->exam_12th_marks,
